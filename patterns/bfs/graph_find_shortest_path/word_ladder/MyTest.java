...
public class MyTest {
    ...
    @Test
    public void simple() {
        Solution s = new BFSFindShortestPath();
    ...
    public void bfsTermination() {
        ...
        assertEquals(0, s.ladderLength(beginWord, endWord, wordList));
    }

    @Test
    public void largerInput599() {
        Solution s = new BFSFindShortestPath();
        ...
        assertEquals(11, s.ladderLength(beginWord, endWord, wordList));
    }
